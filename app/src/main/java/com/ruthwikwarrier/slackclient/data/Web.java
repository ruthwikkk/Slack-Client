package com.ruthwikwarrier.slackclient.data;

public class Web {

    public static final String BaseUrl = "https://slack.com/api/";


    public static final String rtmConnect = BaseUrl + "rtm.connect";
